...
module.exports = function(opts) {
  ...
  //console.log(opts.globs)

  if (opts.prompts) modulePrompts = modulePrompts.concat(opts.prompts);
  ...
  .then(function (data) {
    ...
    startPrompts(configs, opts.globs, opts.callback);
  })
};


function startPrompts(data, extraGlobs, cb) {

  var globs = [
    {base: '../templates/', glob: '*'},
    {base: '../../nyg-ui-generator/templates/{{type}}', output: '/'},
    {base: '../../nyg-ui-generator/templates/tests/{{type}}', output: '/'}
  ];

  //if (extraGlobs) globs = globs.concat(extraGlobs);
  //console.log(globs);
